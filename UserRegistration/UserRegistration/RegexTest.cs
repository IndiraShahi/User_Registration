...
namespace UserRegistration
{
    ...
    {
        public static string _firstName = "^[A-Z]{1}[a-zA-z]{2,10}";
        public static string _lastName = "^[A-Z]{1}[a-zA-z]{2,10}";
        public static string _testEmail = "^[A-Za-z0-9+.-]{3,20}@[A-Za-z0-9]{1,10}.+(com|co.in|net|com.au)$";
        public static string _mobileNumber = "^[9]{1}[1]{1}\\s[6-9]{1}[0-9]{9}";
        public static string _password = "^(?=.*[A-Z])(?=.*[0-9])(?=.*[~!@#$%^&*.-])[a-zA-Z0-9].{7,}$";
